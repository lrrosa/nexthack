...
$csrcs = 'mainentry','nexthack','platform','platform_init','rng','level','levelgen','levelfov','monster','monster_ai','monster_spawn','item','sfx','leveltmpl','classes','spells','scr','title_scr','victory_scr'
