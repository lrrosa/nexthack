...
$csrcs = 'mainentry','nexthack','nexthack_lvl','platform','platform_init','rng','level','levelgen','levelfov','monster','monster_ai','monster_spawn','item','sfx','music','leveltmpl','classes','spells','scr','title_scr','victory_scr'
