...
$csrcs = 'mainentry','nexthack','attract','nexthack_lvl','platform','platform_init','rng','level','levelgen','levelfov','monster','monster_ai','monster_spawn','item','item_use','sfx','music','leveltmpl','classes','spells','scr','title_scr','victory_scr'
