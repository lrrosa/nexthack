...
$srcs   = 'mainentry','nexthack','platform','platform_init','rng','level','levelgen','levelfov','monster','monster_ai','monster_spawn','item','sfx','leveltmpl','classes','spells','titlegfx0','titlegfx1','titlegfx2','titlepal','victorygfx0','victorygfx1','victorygfx2','victorypal'
