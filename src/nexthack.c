...
/* __banked, not static: build_level lives in nexthack_lvl.c now, in another
 * bank. The sprung set is DATA (resident either way); only the call crosses. */
void traps_reset(void) __banked { n_sprung = 0; }
