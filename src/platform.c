...
const uint8_t udg_ink[NTILES] = {
    ...
    /* SHOPWALL KEEPER  LEPRECHAUN YELLOWLIGHT TRAP HOMUNCULUS WRAITH ALTAR WAND FEYE */
       6,       3,          4,          6,        2,      2,        7,     7,    5,   1
    /* keeper magenta; leprechaun green; yellow light yellow; trap+imp red; wraith+altar white; wand cyan; eye blue */
};
